...
namespace Telegram.Bot.Tests.Integ.Sending_Messages
{
    ...
    public class TextMessageTests2 : IClassFixture<TextMessageTests.Fixture>
    {
        ...
        public TextMessageTests2(TestsFixture testsFixture, ITestOutputHelper testOutputHelper)
        {
        ...
        public async Task Should_Send_Text_Message()
        {
            ...
            using (IWebDriver driver = new FirefoxDriver())
            {
                ...
                _testOutputHelper.WriteLine("Page title is: " + driver.Title);
            }
